...
KNOWN_GAMES = [
    ("Anguilla Mañana",3), ("Anguilla Medio Día",3), ("Anguilla Tarde",3), ("Anguilla Noche",3),
    ("La Primera Día",3), ("La Primera Noche",3),
    ("Quiniela Real",3), ("Loto Pool (Real)",4),
    ("La Suerte",3), ("King Lottery",3),
    ("Quiniela Lotedom",3), ("Gana Más",3), ("Juega + Pega +",5),
    ("Nueva York Día",3), ("Nueva York Noche",3),
    ("Florida Día",3), ("Florida Noche",3),
    ("Lotería Nacional",3), ("Pega 3 Más",3),
    ("Quiniela Leidsa",3), ("Super Kino TV",20), ("Loto Pool (Leidsa)",5),
]
...
def lotteries():
    ...
    return {"lotteries":sorted([r[0] for r in rows])}
